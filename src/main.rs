...
fn main() {
    ...
    println!("angle: {}", find_angle_at_p2_as_rad(p1, p2, p3));
}

fn find_angle_at_p2_as_rad(p1: Coordinate, p2: Coordinate, p3: Coordinate) -> f32 {
    ...
    return (dist_p1p2.powi(2) + dist_p2p3.powi(2)
        - dist_p3p1.powi(2) / 2.0 * dist_p1p2 * dist_p2p3)
        .acos();
}
